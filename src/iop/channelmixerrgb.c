...
#define NOTEBOOK_PAGE(var, short, label, tooltip, section, swap)              \
  ...
  DT_BAUHAUS_COMBOBOX_NEW_FULL(darktable.bauhaus, g->checkers_list, DT_GUI_MODULE(self), NULL, N_("chart"),
  ...
  DT_BAUHAUS_COMBOBOX_NEW_FULL(darktable.bauhaus, g->optimize, DT_GUI_MODULE(self), NULL, N_("optimize for"),
