...
static inline void set_RGB_sliders(GtkWidget *R, GtkWidget *G, GtkWidget *B, float hsl[3], float *p, int mode)
{
  ...
  if(hsl[0] != -1)
  {
    ...
    ++darktable.gui->reset;
    dt_bauhaus_slider_set_from_param(R, p[CHANNEL_RED]);
    dt_bauhaus_slider_set_from_param(G, p[CHANNEL_GREEN]);
    dt_bauhaus_slider_set_from_param(B, p[CHANNEL_BLUE]);
    --darktable.gui->reset;
  }
}
...
static inline void set_HSL_sliders(GtkWidget *hue, GtkWidget *sat, float RGB[4])
{
  ...
  */
  ...
  if(h != -1.0f)
  {
    dt_bauhaus_slider_set_from_param(hue, h * 360.0f);
    dt_bauhaus_slider_set_from_param(sat, s * 100.0f);
    update_saturation_slider_color(GTK_WIDGET(sat), h);
    gtk_widget_queue_draw(GTK_WIDGET(sat));
  }
  else
  {
    dt_bauhaus_slider_set_from_param(hue, -1.0f);
    dt_bauhaus_slider_set_from_param(sat, 0.0f);
    gtk_widget_queue_draw(GTK_WIDGET(sat));
  }
}
...
static void apply_autogrey(dt_iop_module_t *self)
{
  ...
  ++darktable.gui->reset;
  dt_bauhaus_slider_set_from_param(g->grey, p->grey);
  --darktable.gui->reset;
...
// Save the patch color for the optimization
  ...
  ++darktable.gui->reset;
  dt_bauhaus_slider_set_from_param(g->lift_r, p->lift[CHANNEL_RED]);
  dt_bauhaus_slider_set_from_param(g->lift_g, p->lift[CHANNEL_GREEN]);
  dt_bauhaus_slider_set_from_param(g->lift_b, p->lift[CHANNEL_BLUE]);
...
// Save the patch color for the optimization
  ...
  ++darktable.gui->reset;
  dt_bauhaus_slider_set_from_param(g->gamma_r, p->gamma[CHANNEL_RED]);
  dt_bauhaus_slider_set_from_param(g->gamma_g, p->gamma[CHANNEL_GREEN]);
  dt_bauhaus_slider_set_from_param(g->gamma_b, p->gamma[CHANNEL_BLUE]);
...
// Save the patch color for the optimization
  ...
  ++darktable.gui->reset;
  dt_bauhaus_slider_set_from_param(g->gain_r, p->gain[CHANNEL_RED]);
  dt_bauhaus_slider_set_from_param(g->gain_g, p->gain[CHANNEL_GREEN]);
  dt_bauhaus_slider_set_from_param(g->gain_b, p->gain[CHANNEL_BLUE]);
...
static void apply_lift_auto(dt_iop_module_t *self)
{
  ...
  ++darktable.gui->reset;
  dt_bauhaus_slider_set_from_param(g->lift_factor, p->lift[CHANNEL_FACTOR]);
  --darktable.gui->reset;
...
static void apply_gamma_auto(dt_iop_module_t *self)
{
  ...
  ++darktable.gui->reset;
  dt_bauhaus_slider_set_from_param(g->gamma_factor, p->gamma[CHANNEL_FACTOR]);
  --darktable.gui->reset;
...
static void apply_gain_auto(dt_iop_module_t *self)
{
  ...
  ++darktable.gui->reset;
  dt_bauhaus_slider_set_from_param(g->gain_factor, p->gain[CHANNEL_FACTOR]);
  --darktable.gui->reset;
