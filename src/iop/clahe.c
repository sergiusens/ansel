...
void gui_init(struct dt_iop_module_t *self)
{
  ...
  g->scale1 = dt_bauhaus_slider_new_with_range(darktable.bauhaus, NULL, 0.0, 256.0, 0, p->radius, 0);
  g->scale2 = dt_bauhaus_slider_new_with_range(darktable.bauhaus, NULL, 1.0, 3.0, 0, p->slope, 2);
