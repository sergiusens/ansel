...
void gui_init(dt_lib_module_t *self)
{
  ...
  d->papers = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  d->printers = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  d->media = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  d->pprofile = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  d->pintent = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  GtkWidget *ucomb = dt_bauhaus_combobox_new_full(darktable.bauhaus, NULL, NULL, _("measurement units"), NULL, (int)d->unit,
  ...
  d->profile = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  d->intent = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  d->style = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
  ...
  d->style_mode = dt_bauhaus_combobox_new(darktable.bauhaus, NULL);
